...
/**
 * 单个ViewHolder 通用 Adapter
 *
 * @param <T>
 */
public abstract class BaseOneViewHolderAdapter<T> extends BaseAdapter {
     ...
     */
    public BaseOneViewHolderAdapter(Context context, List<T> mDatas, int itemLayoutId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (itemViewType) {
            case TYPE_ITEM:
                ...
                final BaseViewHolder baseViewHolder = getViewHolder(position, convertView, parent);
